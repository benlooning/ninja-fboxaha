 ...
 */
function PowerNET(box, index, logger, node) {
 ...
 */
PowerNET.prototype.write = function(data) {
...
PowerNET.prototype.getMeterState = function(box, index) {
  var self = this;
