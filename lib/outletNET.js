...
util.inherits(OutletNET,stream);

module.exports=OutletNET;
 ...
 */
function OutletNET(box, index, logger, node) {
 ...
 */
OutletNET.prototype.write = function(data) {
 var self = this;
...
OutletNET.prototype.getSwitchState = function(box, index) {
  var self = this;
  box.ahaDevices[index].outletTimer = setInterval(function() {
	box.getSwitchStateNET (box.ahaDevices[index].ID, -1, function (error, state) {
	  if (error == null) {
